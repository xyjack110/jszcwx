...
Page({
  ...
  WorkRecordDetail:function(e){
    console.log(e.currentTarget.id+"hhh")
    wx.navigateTo({ url: '/eqpt/eqptDetail/WorkRecordDetail/WorkRecordDetail?fID=' + e.currentTarget.id })
  },
  //去掉部门全名称的前两个字符
  ...
  LoadRepairInfoRecord: function (offset, append) {
    ...
    var me = this
    wx.request({
      url: requestUrl + '/queryWorkRecord',
      method: "POST",
      data: {
        psnFilter: psnFilter,
