// eqpt/mine/mineReceiveEvalue/mineReceiveEvalue.js
var app = getApp()
...
Page({
  ...
  LoadMineEvakueRecord: function (offset, append) {
    ...
    var me = this
    wx.request({
      url: requestUrl + '/queryMineReceiveEvakueRecord',
      method: "POST",
      data: {
        psnFilter: psnFilter,
      ...
      success: function (res) {
        ...
        for (var i = 0; i < res.data.rows.length; i++) {
          t = res.data.rows[i].fOperationImg.value?res.data.rows[i].fOperationImg.value.split("@"):[];
          ...
          // if (res.data.rows[i].fDeptFName1.value == ".") {
          //   if (res.data.rows[i].fMyDept1.value) {
          //     res.data.rows[i].fDeptName = res.data.rows[i].fCmpyName1.value + "/" + res.data.rows[i].fMyDept1.value 
          //   } else {
          //     res.data.rows[i].fDeptName = res.data.rows[i].fCmpyName1.value 
          //   }
          ...
          //   if (res.data.rows[i].fMyDept1.value) {
          //     res.data.rows[i].fDeptName = res.data.rows[i].fCmpyName1.value + "/" + me.getfDeptFName(res.data.rows[i].fDeptFName1.value) + "/" + res.data.rows[i].fMyDept1.value 
          //   } else {
          //     res.data.rows[i].fDeptName = res.data.rows[i].fCmpyName1.value + "/" + me.getfDeptFName(res.data.rows[i].fDeptFName1.value) 
          //   }
