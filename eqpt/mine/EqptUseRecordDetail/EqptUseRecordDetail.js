// eqpt/mine/EqptUseRecordDetail/EqptUseRecordDetail.js
  ...
  onLoad: function (options) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        res.data.rows[0].fNameJson = JSON.parse(res.data.rows[0].fOperationJson.value).deptName+'/'+ JSON.parse(res.data.rows[0].fOperationJson.value).fPsnName
       // res.data.rows[0].fOperationJson =res.data.rows[0].fOperationJson
        res.data.rows[0].fName = res.data.rows[0].fName.value
