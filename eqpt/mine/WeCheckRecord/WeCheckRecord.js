// eqpt/mine/WeCheckRecord/WeCheckRecord.js
...
Page({   
  ...
  LoadRepairInfoRecord: function (offset, append) {
    ...
    var me = this
    wx.request({
      url: requestUrl + '/queryCheck1Record',
      method: "POST",
      data: {
        psnFilter: psnFilter,
      ...
      success: function (res) {
        ...
        if (append == true) {
          me.setData({
            ...
            checkRecordList: me.data.checkRecordList.concat(res.data.rows)
          })
        } else {
          me.setData({

            checkRecordList: res.data.rows
          })
        }
  ...
  checkRecordDetail: function (e) {

    wx.navigateTo({ url: '/eqpt/mine/check1RecordDetail/check1RecordDetail?fID=' + e.currentTarget.id })
  },
  ...
  onReachBottom: function () {
    this.LoadRepairInfoRecord(this.data.checkRecordList.length, true)
  },
